                    ...
                    <form className={`space-y-4 ${isMobile ? 'md:space-y-4 space-y-3 px-4 py-6' : ''}`} onSubmit={this.handleSubmit}>
                        ...
                        <div className='flex gap-x-2'>
                            <div className="relative">
                                ...
                                <label
                                    htmlFor="fname"
                                    className={`absolute left-3 transition-all duration-300 peer-placeholder-shown:top-2 peer-placeholder-shown:left-3 peer-placeholder-shown:text-[#e27daa] peer-focus:-top-5 peer-focus:left-2 peer-focus:text-[#e27daa] ${fname ? 'top-[-18px] text-[#e27daa]' : 'text-[#e27daa]'}`}
                                >
                                    First Name
                                </label>
                            </div>
