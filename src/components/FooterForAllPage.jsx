...
class FooterForAllComponent extends React.Component {
    render() {
        return (
            <footer className="pt-8 bg-gray-100 text-gray-800">
                ...
                <div className="py-2 text-center mt-8 flex justify-between flex-col md:flex-row text-[#e5659f] border-t border-gray-300">
                    <p className="w-full text-sm md:ml-32">© 2021 All Rights Resrved by RegTech</p>
...
export default FooterForAllComponent;
